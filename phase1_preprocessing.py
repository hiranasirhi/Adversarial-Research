...
file_path = "/home/kali/Desktop/UNSW_NB15_testing-set.parquet"  # Update path if 
needed 
...
categorical_cols = ['proto', 'service', 'state', 'attack_cat']  # based on 
dataset 
...
# Exclude columns that are not features (like target labels) 
