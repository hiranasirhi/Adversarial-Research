...
clean and adv examples. 
    We'll compute gradients of standard CE loss w.r.t input and compute 1 - 
cosine_similarity. 
    """ 
    ...
    grad_clean = torch.autograd.grad(loss_clean, x_clean_req, retain_graph=True, 
create_graph=False)[0] 
    # Adv grads 
    out_adv = model(x_adv_req) 
    loss_adv = F.cross_entropy(out_adv, y) 
    grad_adv = torch.autograd.grad(loss_adv, x_adv_req, retain_graph=False, 
create_graph=False)[0] 
